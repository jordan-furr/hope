        ...
        <div className='page evergreen'>
            ...
            <div className='pageContent'>
                ...
                <div className='mt3 mb5 margin-a'>
                    <p className='mb6'>Here you'll find voices that speak to nature's wisdom, the practice of regeneration, and the infinite game of becoming.</p>
                    <p className='mb3 bold'>Erik de Jong</p>
                    <p className="mb6">
                   ...
                   <p className='mb3 bold'>James Carse</p>
                    <p className="mb5">
